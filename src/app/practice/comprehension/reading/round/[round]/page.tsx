...
import { ReadingRoundDifficultyHub } from "@/components/reading/ReadingRoundDifficultyHub";
...
export default async function ReadingRoundPage({ params }: { params: Promise<{ round: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-8">
      <ReadingRoundDifficultyHub round={round} />
    </main>
  );
}
