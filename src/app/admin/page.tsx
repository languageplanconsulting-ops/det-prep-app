    ...
    <main className="mx-auto max-w-3xl space-y-6 px-4 py-8">
      <header className="ep-brutal rounded-sm border-black bg-white p-6">
        ...
        <p className="mt-4 flex flex-wrap gap-2 text-sm">
          ...
          <Link
            href="/admin/billing"
            className="inline-flex items-center rounded-[4px] border-4 border-black bg-[#dcfce7] px-4 py-2 font-black uppercase tracking-wide text-neutral-900 shadow-[4px_4px_0_0_#000] hover:translate-x-px hover:translate-y-px hover:shadow-none"
            style={{ fontFamily: "var(--font-jetbrains), monospace" }}
          >
          ...
          <Link
            href="/practice"
            className="inline-flex items-center rounded-[4px] border-4 border-black bg-violet-200 px-4 py-2 font-black uppercase tracking-wide text-neutral-900 shadow-[4px_4px_0_0_#000] hover:translate-x-px hover:translate-y-px hover:shadow-none"
            style={{ fontFamily: "var(--font-jetbrains), monospace" }}
          >
            Lessons + study-plan calendar (preview) →
          </Link>
          <a
