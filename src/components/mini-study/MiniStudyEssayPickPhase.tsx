    ...
    <main className="mx-auto max-w-3xl space-y-6 px-4 py-8">
        ...
        {ex.options.map((o) => {
          ...
          return (
            <button
              ...
              disabled={checked}
              className={`block w-full rounded-sm border-4 p-4 text-left shadow-[4px_4px_0_0_#111] ${colorClass}`}
            >
      ...
      {checked ? (
        <div className="space-y-3">
          ...
          <div className="overflow-x-auto rounded-sm border-2 border-[#004AAD] bg-[#eef4ff] p-3">
          ...
          <div className="rounded-sm border-2 border-black bg-white p-3 text-sm leading-7">
