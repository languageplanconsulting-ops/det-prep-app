...
สำหรับนักเรียนคอร์ส Duolingo ของ English Plan นักเรียนจะได้รับสิทธิ์ใช้ instant feedback ได้ 15 ครั้งต่อสัปดาห์ ครอบคลุมทุกพาร์ตที่รองรับ โดยสิทธิ์นี้จะ รีเซ็ตใหม่ทุกวันจันทร์ และ จะไม่สะสมไปสัปดาห์ถัดไป นะครับ ดังนั้นแนะนำให้วางแผนใช้ให้คุ้มค่าในแต่ละสัปดาห์ครับ
