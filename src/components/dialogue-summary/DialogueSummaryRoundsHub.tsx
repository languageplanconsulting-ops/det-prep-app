    ...
    <div className="space-y-8">
      <header className="ep-brutal rounded-sm border-4 border-black bg-white p-6 shadow-[4px_4px_0_0_#000]">
        ...
        <p className="mt-2 max-w-2xl text-sm text-neutral-600">
          Read the scenario and dialogue, then write a summary (min. 20 words). Graded /160 with bilingual feedback.
          Averages use your best score per set as a percent of 160; the date is your most recent attempt in that
          round.
        </p>
      </header>
