...
export const MINI_STUDY_SESSIONS: MiniStudySession[] = [
  ...
  },
  {
    ...
    subtitle: "15 นาที · 3 patterns บรรยายภาพ + ระบบตรวจให้",
    durationLabel: "≈ 15 min",
    kind: "write-about-photo",
    category: "writing",
    tierRequired: "premium",
    shortHookTh: "3 pattern + คำคุณศัพท์ที่ใช้ได้จริง — ระบบตรวจให้ + ให้คะแนนทันที",
    explanation: [
      {
        heading: "วิธีเรียนบทนี้",
        body: "อ่าน 3 patterns และคำคุณศัพท์ที่ให้ ก่อนเขียนบรรยายภาพด้านล่างโดยเลือก pattern ใด pattern หนึ่ง เมื่อส่งแล้วระบบจะตรวจให้และคุณบันทึกลง notebook ได้",
      },
      {
      ...
      },
      {
        ...
        body: "เขียน **3-5 ประโยค** โดยใช้ pattern ใด pattern หนึ่งข้างบน ใส่ transition word อย่างน้อย 1 คำ และคำคุณศัพท์จากแต่ละหมวดให้ได้ พอเสร็จกด **Submit** เพื่อรับฟีดแบ็ก",
      },
    ],
    photo: {
    ...
    explanation: [
      {
        ...
        coachTip: "**พูดช้ากว่าปกตินิดนึงนะครับ** — ชัดดีกว่าเร็วเสมอ DET ฟัง **pronunciation** และ **clarity** มากกว่าความเร็วในการพูด ถ้านักเรียนรีบจนเสียงไม่ชัด ระบบจับคำไม่ได้ → ได้คะแนนน้อยกว่าคนพูดช้าและชัด เคล็ดลับ: ลองนึกว่ากำลังพูดคุยกับเพื่อนต่างชาติที่เพิ่งเรียนภาษาอังกฤษ — นักเรียนจะออกเสียงชัดเองโดยอัตโนมัติครับ",
      },
      {
      ...
      },
      {
        ...
        body: "กดปุ่ม mic แล้วพูดให้ครบ 6 ประโยคโดยใช้ pattern ใด pattern หนึ่ง ถ้าใช้ mic ไม่ได้ พิมพ์ในกล่องก็ได้ พอเสร็จกด Submit เพื่อรับฟีดแบ็ก (บันทึก notebook ได้จากหน้า report)",
      },
    ],
    photo: {
