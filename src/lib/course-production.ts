...
export const COURSE_VIDEO_PLAN: CourseVideoPlan[] = [
  ...
  // ---- Grammar foundation: one video per drilled rule ----
  // The curriculum has six grammar exercises but the course only had two
  // grammar videos between them, so five rules were being drilled untaught.
  {
    key: "a13-grammar-fanboys",
    titleTh: "คำเชื่อม FANBOYS — คอมมาวางตรงไหน",
    questionType: "interactive_writing",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 130,
    script: script({
      goal: "ให้ผู้เรียนวางคอมมาหน้า FANBOYS ได้ถูกทุกครั้ง",
      hook: "“ประโยคเดียว คอมมาผิดที่ ก็เสียคะแนนเขียนแล้ว” เปิดด้วยประโยคผิด 2 ประโยค",
      beats: [
        "FANBOYS = for, and, nor, but, or, yet, so",
        "สูตร: S+V, but S+V. — คอมมาอยู่ “หน้า” คำเชื่อมเสมอ",
        "ถ้าหลังคำเชื่อมไม่ใช่ประโยคสมบูรณ์ (S+V) → ไม่ต้องใส่คอมมา",
        "เทียบให้เห็นคู่ผิด–ถูก 5 คู่",
      ],
      drill: "10 ประโยค ให้พิมพ์แก้คอมมาเอง (ตรงกับแบบฝึก gr-conj)",
    }),
  },
  {
    key: "a14-grammar-subordinating",
    titleTh: "Although / because / until — อนุประโยคขึ้นต้นกับลงท้าย",
    questionType: "interactive_writing",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 131,
    script: script({
      goal: "แยกให้ออกว่าเมื่อไหร่ต้องใส่คอมมา เมื่อไหร่ห้ามใส่",
      hook: "“คำเดียวกัน วางคนละที่ กฎคอมมาต่างกันเลย”",
      beats: [
        "although, even if, because, until, as soon as, as long as",
        "ขึ้นต้น: Although S+V, S+V. → ต้องมีคอมมา",
        "ลงท้าย: S+V until S+V. → ห้ามใส่คอมมา",
        "ข้อผิดที่เจอบ่อยที่สุด: ใส่คอมมาเกินหน้า because",
      ],
      drill: "10 ประโยคคละทั้งสองแบบ",
    }),
  },
  {
    key: "a15-grammar-transitions",
    titleTh: "Transitional words — However, Moreover, In contrast",
    questionType: "interactive_writing",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 132,
    script: script({
      goal: "ใช้คำเชื่อมความได้ถูกตำแหน่งและถูกเครื่องหมาย",
      hook: "“คำพวกนี้ทำให้คะแนนเขียนขึ้นเร็วที่สุด ถ้าใช้ถูก”",
      beats: [
        "สูตร: However, S+V. — ขึ้นต้นประโยคใหม่แล้วตามด้วยคอมมา",
        "ห้ามใช้คอมมาเชื่อมสองประโยคเฉย ๆ (comma splice)",
        "จับคู่ความหมาย: ขัดแย้ง / เสริม / เปรียบเทียบ",
        "7 คำที่ควรใช้ให้คล่อง",
      ],
      drill: "7 ข้อ เขียนใหม่โดยใช้คำที่กำหนด",
    }),
  },
  {
    key: "a16-grammar-runon",
    titleTh: "Run-on sentence — 3 วิธีแก้",
    questionType: "interactive_writing",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 133,
    script: script({
      goal: "ตรวจจับและแก้ run-on ได้เองในงานเขียนของตัวเอง",
      hook: "“ประโยคยาวไม่ผิด — ประโยคชนกันต่างหากที่ผิด”",
      beats: [
        "run-on = ประโยคสมบูรณ์ (S+V) สองประโยคชนกันโดยไม่มีตัวคั่น",
        "วิธีที่ 1: ใส่จุด → S+V. S+V.",
        "วิธีที่ 2: ใส่ semicolon → S+V; S+V.",
        "วิธีที่ 3: คอมมา + FANBOYS → S+V, so S+V.",
        "comma splice: ใส่คอมมาเฉย ๆ ยังผิดอยู่",
      ],
      drill: "7 ประโยค ให้พิมพ์แก้ทีละประโยค",
    }),
  },
  {
    key: "a17-grammar-relative",
    titleTh: "which / who / that — ใส่คอมมาเมื่อไหร่",
    questionType: "interactive_writing",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 134,
    script: script({
      goal: "แยกอนุประโยคแบบเสริมกับแบบจำกัดความให้ออก",
      hook: "“คอมมาสองตัวนี้เปลี่ยนความหมายประโยคได้เลย”",
      beats: [
        "ข้อมูลเสริม: N, which S+V, V… → คอมมาคร่อมสองข้าง",
        "จำกัดความ: N that S+V… → ห้ามใส่คอมมา",
        "หลัง that ห้ามมีคอมมาเด็ดขาด",
        "ทดสอบง่าย ๆ: ตัดอนุประโยคออกแล้วยังรู้เรื่องไหม",
        "อย่าลืมผันกริยาหลักตามประธานเดิม",
      ],
      drill: "7 ประโยค ให้พิมพ์แก้ทั้งประโยค (คอมมา + การผันกริยา)",
    }),
  },
  {
    key: "a18-grammar-present-s",
    titleTh: "Present simple -s/-es — เขียนถูกแล้วต้องพูดให้ได้ยินด้วย",
    questionType: "speak_about_photo",
    level: "beginner",
    group: "A",
    status: "missing",
    ...
    priority: 135,
    script: script({
      goal: "เติม -s/-es ได้ถูก และออกเสียงท้ายคำให้ได้ยินชัดตอนพูด",
      hook: "“คนไทยเขียน -s ถูก แต่พอพูดหายไป — กรรมการได้ยินว่าผิด”",
      beats: [
        "สูตร: He / She / It / N(เอกพจน์) + V-s",
        "แพตเทิร์นที่ใช้ได้จริง: This picture depicts… / Judging from the background, I believe that…",
        "แพตเทิร์นสำหรับพูดตามหัวข้อ: In my opinion, technology changes…",
        "ฝึกออกเสียงท้ายคำ /s/ /z/ /ɪz/",
        "เกณฑ์: ตรงกัน 95% ขึ้นไป และห้ามตกเสียงท้ายคำแม้แต่คำเดียว",
      ],
      drill: "4 แพตเทิร์น เติมกริยา แล้วอัดเสียงพูดทั้งประโยค",
    }),
  },
